<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ISE_TEST_V1.Models.PagedList<ISE_TEST_V1.Models.Test>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
            ...
            <td>
                <% if (Convert.ToBoolean(item.valid))
                 ...
                 <%}
                   ...
                   { %>
                 No <%: Html.ActionLink("Validate", "Validate", new { id = item.ID })%>
                 <%} %>
            </td>
        </tr>
    ...
    <% ISE_TEST_V1.Models.HtmlHelpers.ShowPagerControl(this, Model, "Tests", "Page"); %>
