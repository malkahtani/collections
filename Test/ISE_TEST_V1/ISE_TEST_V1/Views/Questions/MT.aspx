...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <% 
     ...
     <%= Html.Telerik().EditorFor(m => m[0].mt.q.Text).HtmlAttributes(new { style = "width: 400px;" }) %>
     ...
     <% int myloop = Model.ElementAt(0).NOA;
        ...
        for (int i = 0; i < myloop; i++)
        {
            ...
            <tr>
            <td><p>  <%: i+1 %> -</p></td>
            <td> <%= Html.Telerik().EditorFor(m => m[i].mt.my_mt_answers.TEXT).HtmlAttributes(new { style = "width: 400px;" })%></td>
           
            <td><%: Html.TextBoxFor(m => m[negloop-i].mt.my_mt_answers.PID)%></td>
            <td><%= Html.Telerik().EditorFor(m => m[negloop - i].mt.my_mt_answers.TEXT).HtmlAttributes(new { style = "width: 400px;" })%></td>
